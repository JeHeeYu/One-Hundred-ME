...
class FailStampSelectPage extends StatefulWidget {
  const FailStampSelectPage({super.key});

  @override
  _FailStampSelectPageState createState() => _FailStampSelectPageState();
}

class _FailStampSelectPageState extends State<FailStampSelectPage> {
  int selectedIndex = -1;
        ...
        child: Container(
          ...
          child: SizedBox(
            ...
            child: Column(
              children: [
                const HeaderWidget(
                  titleText: Strings.strFailStampSelect,
                ),
                Expanded(
                  child: Column(
                    children: [
                ...
                Padding(
                  ...
                  child: const Text(
                    Strings.strFailStampSelectGuide,
                    style: TextStyle(
                      fontSize: 16,
                ...
                MouseRegion(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.of(context).pushNamed(RoutesName.endDaySelect);
                      userSettingController.setFailStampImage(selectedIndex);
                    },
                    child: Padding(
